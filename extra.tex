...
\noi $1$. Show that the field of all numbers of the form $a+b\sqrt{2}$ for $a,b\in \QQ$ admits a nonstandard ordereing (that is, not the one comming from the standard ordering of real numbers).
